...
class ExtensionObject {
    ...
    constructor(clone) {
        if (clone) {
            if (clone.includeQuiz !== undefined)
                this.includeQuiz = clone.includeQuiz;
            if (clone.includeElearnVideo !== undefined)
                this.includeElearnVideo = clone.includeElearnVideo;
            if (clone.includeClickImage !== undefined)
                this.includeClickImage = clone.includeClickImage;
            if (clone.includeTimeSlider !== undefined)
                this.includeTimeSlider = clone.includeTimeSlider;
        }
    }
}
